...
function ProgressBar({step,totalStep}) {
    ...
    return(
        <div className="flex flex-col items-start justify-around  pl-6 py-10 w-[360px] min-h-screen border-r bg-white">
            {steps.map((s, i) => (
        ...
        `}
                    ...
                    <div className='text-black text-xl font-medium pt-4'><h1>{steps[i].text}</h1></div>
